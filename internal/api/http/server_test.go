...
func TestHTTPRoutes(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "process list", method: http.MethodGet, path: "/api/v1/processlist", status: http.StatusOK, body: `"pid":10`},
		{name: "process count", method: http.MethodGet, path: "/api/v1/processcount", status: http.StatusOK, body: `"total":2`},
		{name: "program list", method: http.MethodGet, path: "/api/v1/programlist", status: http.StatusOK, body: `"name":"nginx"`},
