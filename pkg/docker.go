...
import (
	...
	"github.com/mordilloSan/go-monitoring/internal/entities/system"
	"github.com/mordilloSan/go-monitoring/pkg/deltatracker"
...
func calculateMemoryUsage(apiStats *container.ApiStats) (uint64, error) {
